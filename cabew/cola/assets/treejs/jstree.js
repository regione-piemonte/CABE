 ...
 */
	...
	_temp1 = _d.createElement('SPAN');
	_temp1.className = 'content col-md-9';
	...
	_temp0.appendChild(_temp1);
	_temp1 = _d.createElement('SPAN');
	_temp1.className = 'controls col-md-2';
	_temp2 = _d.createElement('I');
	_temp2.className = 'fa fa-pencil';
	_temp1.appendChild(_temp2);
	_temp2 = _d.createElement('I');
	_temp2.className = 'fa fa-eye';
	_temp1.appendChild(_temp2);
	_temp2 = _d.createElement('I');
	_temp2.className = 'cerchietto';
	_temp1.appendChild(_temp2);
	_temp0.appendChild(_temp1);
	_temp1 = _d.createElement('SPAN');
	_temp1.className = 'type col-md-2';
	_temp2 = _d.createElement('I');
