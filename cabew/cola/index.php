...
//		$resp->addHeader("X-Content-Security-Policy", "script-src 'self' ajax.googleapis.com nominatim.openstreetmap.org maps.googleapis.com cdn.knightlab.com 'unsafe-inline' 'unsafe-eval';"); 
		...
		$resp->addHeader("Content-Security-Policy", "script-src 'self' ajax.googleapis.com nominatim.openstreetmap.org maps.googleapis.com cdn.knightlab.com 'unsafe-inline' 'unsafe-eval' data: blob:;");
              $resp->addHeader("X-Content-Security-Policy", "script-src 'self' ajax.googleapis.com nominatim.openstreetmap.org maps.googleapis.com cdn.knightlab.com 'unsafe-inline' 'unsafe-eval' data: blob:;");
// CSI AF 21/01/2020E
