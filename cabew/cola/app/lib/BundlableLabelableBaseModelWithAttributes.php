...
class BundlableLabelableBaseModelWithAttributes extends LabelableBaseModelWithAttributes implements IBundleProvider {
	...
	// CSI AF 05/12/19S
	// variabile che conterrà ApplicationPluginManager per invocare il custom hook
	...
	public function __construct($pn_id=null) {
		...
		// CSI AF 05/12/19S
		// istanzio ApplicationPluginManager per invocare il custom hook
...
$pa_options["display_form_field_tips"] = true;
	...
	*
	...
	public function checkACLAccessForUser($t_user, $pn_id=null) {
		...
		// CSI AF 05/12/2019S
		// invoco hook custom "hookCSIcheckACLAccessForUser" e ritorno l'accessLevel
		

		$accessLevel = ca_acl::accessForRow($t_user, $this->tableNum(), $pn_id);
		...
		//var_dump($t_user->getUserId(), $accessLevel);die;
		
		$pa_params = $this->opo_app_plugin_manager->hookCSIcheckACLAccessForUser($pa_params);

		return $pa_params['access_level'];		
